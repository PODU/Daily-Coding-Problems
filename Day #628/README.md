...
Find the minimum number of single-wheel rotations to turn a 3-wheel combination lock from 000 to a target, avoiding "dead end" combinations, or return None if unreachable.
