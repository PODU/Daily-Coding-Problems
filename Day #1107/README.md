...
Given a tree with an even number of nodes, find the maximum number of edges that can be removed so every resulting subtree still has an even number of nodes.
