...
Given an N by N letter board and a dictionary, find the maximum number of dictionary words that can be packed onto the board using adjacent, non-reused tiles.
