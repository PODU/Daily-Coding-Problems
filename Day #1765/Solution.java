// Roman numeral -> decimal: scan left to right; subtract when a symbol's value is
...
public class Solution {
    static int romanToInt(String s) {
        ...
        v.put('M', 1000); v.put('D', 500); v.put('C', 100);
        v.put('L', 50); v.put('X', 10); v.put('V', 5); v.put('I', 1);
        int total = 0;
