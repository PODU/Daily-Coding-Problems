...
In a three-heap game of misere Nim (the player forced to take the last stone loses), determine whether the first player can force a win given starting heap sizes [a, b, c] under optimal play.
