...
public class Solution {
    ...
    static List<List<Integer>> graph(int[][] edges, int n) {
    ...
    public static void main(String[] args) {
        System.out.println(isBipartite(4, graph(new int[][]{{0, 1}, {1, 2}, {2, 3}, {3, 0}}, 4))); // true
        System.out.println(isBipartite(3, graph(new int[][]{{0, 1}, {1, 2}, {2, 0}}, 3)));         // false
    }
}
