...
Given a dictionary mapping words to possible meanings, design an algorithm that picks the most likely sense of each ambiguous word in a sentence based on context.
