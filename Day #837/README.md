...
Build a sentence validator that reads a character stream and prints out sentences that satisfy the given capitalization, spacing, separator, and terminal-mark rules.
