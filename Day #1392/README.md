...
Find the minimum number of single-digit wheel rotations to move a three-wheel lock from 000 to a target combination while avoiding dead-end states, or report impossibility.
