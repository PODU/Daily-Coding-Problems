...
Given listener positions and tower positions on a line, find the smallest radius such that every listener is within that distance of at least one tower.
