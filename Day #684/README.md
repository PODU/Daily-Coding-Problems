...
Implement the reduce/fold higher-order function that folds an array into a single value by repeatedly applying a combining function starting from an initial value.
