...
Implement a deque-like "quack" structure (push/pop on the left, pull from the right) using three stacks and O(1) extra memory, with O(1) amortized time per operation.
