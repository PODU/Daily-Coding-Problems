...
Given an adjacency list of student friendships, count the number of connected components (friend groups), where each group is the transitive closure of friendships.
