...
Design a distributed web crawler that uses a server and a set of client machines to crawl and copy all of Wikipedia, handling coverage, deduplication, blacklisting, and updates.
