# Day 389: Open-ended: contrast composition vs inheritance and when to use each.
...
When to use each:
- Use inheritance for a genuine, stable is-a relationship when you want
  polymorphism over a common base type (e.g., Shape -> Circle, Square).
...
and build flexible, changeable systems with composition."""
