...
Given a row of seats with people and gaps, compute the minimum total movement cost (sum of absolute distances) to seat everyone contiguously with no gaps.
