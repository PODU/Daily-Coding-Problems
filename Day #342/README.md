...
Implement your own version of the reduce (fold) function, which combines all elements of an array left to right using a given combining function and initial value.
