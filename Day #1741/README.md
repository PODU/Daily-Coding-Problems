...
A system design problem: build a distributed web crawler to crawl and copy all of Wikipedia, considering coverage, deduplication, blacklisting, and updates.
