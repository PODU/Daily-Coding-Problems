...
Implement the reduce/fold function that accumulates a result over an array using a combining function and an initial value, processing elements left to right.
