...
Implement a quack (a deque-like structure supporting push/pop on the left and pull on the right) using three stacks with O(1) extra memory and O(1) amortized time per operation.
