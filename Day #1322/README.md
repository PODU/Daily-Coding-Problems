...
### Output
```
Whether the first player has a forced win, assuming optimal play.
```

## Explanation

Given three heap sizes for misere Nim, determine whether the first player can force a win under optimal play.
