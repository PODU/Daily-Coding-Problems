...
Implement the Soundex phonetic encoding algorithm that maps a name to a letter followed by three digits, so that similar-sounding names share the same code.
