...
A system design problem: architect a distributed web crawler to download and store all of Wikipedia, handling coverage, deduplication, blacklisting, and updates.
