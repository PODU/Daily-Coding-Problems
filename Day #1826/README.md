...
Find the time for a message starting at node 0 to reach every node in a weighted network, i.e. the maximum shortest-path distance from node 0. For the example, the path 0 -> 2 -> 3 -> 4 takes 9.
