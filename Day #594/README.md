...
Given a letter grid and dictionary, find the maximum number of non-overlapping dictionary words that can be formed from adjacent tiles, each tile used once.
