...
Design and implement the game Connect 4 on a 7 x 6 grid, detecting a win when a player forms four consecutive discs horizontally, vertically, or diagonally.
