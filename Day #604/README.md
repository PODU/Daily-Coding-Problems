...
Implement the Soundex phonetic encoding algorithm that maps names to a one-letter, three-digit code so similar-sounding names share the same representation.
