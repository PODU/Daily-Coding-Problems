...
Determine how long it takes for a message starting at node 0 to reach every node in the network, given the edge transmission times. You should return 9, because propagating the message from 0 -> 2 -> 3 -> 4 will take that much time.
