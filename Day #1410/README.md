...
Design and implement the game Connect 4 on a 7x6 grid, where players alternate dropping discs and the game ends when one player gets four in a row or the grid fills up.
