...
Design an API for tracking timestamped stock prices that supports adding, updating, and removing datapoints, plus querying the running max, min, and average of all prices seen.
