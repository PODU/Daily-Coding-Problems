...
Using BFS over lock combinations, find the minimum number of single-digit wheel rotations to go from 000 to a target, avoiding dead-end states, or return None if unreachable.
