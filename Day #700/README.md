...
Given direct flight prices between cities, find the cheapest route from an origin to a destination using at most k connections, and report both the price and the itinerary.
