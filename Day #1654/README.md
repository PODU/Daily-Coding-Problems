...
Given a dictionary mapping words to their possible meanings, design an algorithm that picks the most likely meaning for each ambiguous word in a sentence.
