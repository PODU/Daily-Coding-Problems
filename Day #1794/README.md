...
For the misère version of three-heap Nim (the player forced to take the last stone loses), decide whether the first player can force a win under optimal play.
