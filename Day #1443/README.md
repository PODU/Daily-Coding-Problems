...
Given a dictionary mapping words to lists of possible meanings, create an algorithm that picks the most likely meaning of each ambiguous word in a sentence based on context.
