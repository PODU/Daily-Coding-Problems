...
Find the minimum broadcast range so that every listener is within range of some tower. Here range 5 is required so the tower at 15 can reach the listener at 20.
