...
Build a sentence checker that reads a stream of characters and prints out sentences that satisfy the given capitalization, character, spacing, and termination rules.
