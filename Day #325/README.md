...
Build a data structure that converts a quantity from one unit of measure to any other given known conversion ratios, and supports adding new units to the system.
