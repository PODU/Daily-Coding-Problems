...
Implement the Soundex phonetic encoding algorithm, which maps a name to a one-letter, three-digit code so that similar-sounding names share the same representation.
